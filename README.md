    updated on: 18th August 2024, Sunday

<div align=center>
    <a href="https://github.com/SrijaAdhya12/demo-session">
        <img width="200" src="https://img.icons8.com/?size=1000&id=46874" alt="demo-session">
    </a>
    <p style="font-family: roboto, calibri; font-size:12pt; font-style:italic"> A good one liner description here </p>
    <a src="https://github.com/SrijaAdhya12/demo-session/forks">
        <img alt="GitHub forks" src="https://img.shields.io/github/forks/SrijaAdhya12/demo-session">
    </a>
</div>

# [Demo Session](https://github.com/SrijaAdhya12/demo-session)
...
2. Go to [**Security**](https://github.com/SrijaAdhya12/demo-session/security) tab.
3. Click on **Security Overview**.
4. Click on `Enable Dependabot alerts` button.

- Enable Code Scanning Alerts

1. Go to [Code security and analysis](https://github.com/SrijaAdhya12/demo-session/settings/security_analysis#code_scanning_settings) section in settings.
...
<div align="center">
    <a href="https://github.com/SrijaAdhya12/demo-session/graphs/contributors">
        <img src="https://contrib.rocks/image?repo=SrijaAdhya12/demo-session" alt="contributors"/>
    </a>
</div>
